...
export default function Topbar({ name }) {
    const [dropdownOpen, setDropdownOpen] = useState(true); // check dropdown is open or not
    const dropdownTarget = useRef();

    // trigger for dropdown then check is open or not
    const triggerDropdown = () => {
        ...
        setDropdownOpen(!dropdownOpen); // If it is true at first, then it becomes false, and vice versa
    }
        ...
        <div className="flex justify-between items-center cursor-pointer">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="collapsible-dropdown flex flex-col gap-2 relative">
                    ...
                    <div className="bg-gray-200 rounded-2xl text-black font-medium flex flex-col gap-1 absolute z-[999] right-0 top-[80px] min-w-[180px] hidden overflow-hidden"
                        ref={dropdownTarget}>
